        ...
        for (LostItem lost : lostItems) {
            for (FoundItem found : foundItems) {
                if (lost.getItemName().equalsIgnoreCase(found.getItemName())
                        ...
                        && lost.getStatus().equalsIgnoreCase("Unresolved")
                        && found.getStatus().equalsIgnoreCase("Unmatched")) {

                    System.out.println("\nMatch found:");
                    System.out.println("Lost: " + lost);
                    System.out.println("Found: " + found);

                    // Update lost item as resolved
                    lostDAO.updateStatus(lost.getId(), "Resolved");

                    // Update found item as matched and store reference to matched lost item
